...
public class ExamDialog extends JDialog {
    ...
    private void initUI(String title) {
        ...
        topBar.setBackground(ModernTheme.bgDarker());
        ...
        timerPanel.setBackground(ModernTheme.bgDarker());

        JLabel timerIcon = new JLabel("⏱");
        timerIcon.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 18));
        ...
        timerLabel.setFont(ModernTheme.MONO_FONT);
        ...
        progressPanel.setBackground(ModernTheme.bgDarker());
        ...
        bottomBar.setBackground(ModernTheme.bgDarker());
        bottomBar.setBorder(BorderFactory.createEmptyBorder(14, 20, 14, 20));

        JButton submitBtn = ModernTheme.primaryButton("✔  提 交 试 卷");
        submitBtn.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
        submitBtn.setPreferredSize(new Dimension(200, 46));
